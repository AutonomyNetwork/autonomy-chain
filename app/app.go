...
import (
	...
	"github.com/AutonomyNetwork/autonomy-chain/x/launchpad"
	launchpadKeeper "github.com/AutonomyNetwork/autonomy-chain/x/launchpad/keeper"
	launchpadTypes "github.com/AutonomyNetwork/autonomy-chain/x/launchpad/types"
)
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		issuanceTypes.StoreKey, launchpadTypes.StoreKey, authzkeeper.StoreKey, liquiditytypes.StoreKey,
	)
	...
	app.mm.SetOrderEndBlockers(crisistypes.ModuleName, govtypes.ModuleName, stakingtypes.ModuleName, liquiditytypes.ModuleName, launchpadTypes.EventModuleName.Name)
...
// AppCodec returns Autonomy's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
...
// InterfaceRegistry returns Autonomy's InterfaceRegistry
