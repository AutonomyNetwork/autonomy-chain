...
func (*MsgIssueToken) Descriptor() ([]byte, []int) {
	return fileDescriptor_31aa11e9d7228300, []int{0}
}
...
func (*MsgIssueTokenResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_31aa11e9d7228300, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgIssueToken)(nil), "AutonomyNetwork.autonomychain.issuance.v1.MsgIssueToken")
	proto.RegisterType((*MsgIssueTokenResponse)(nil), "AutonomyNetwork.autonomychain.issuance.v1.MsgIssueTokenResponse")
}

func init() { proto.RegisterFile("issuance/v1/tx.proto", fileDescriptor_31aa11e9d7228300) }

var fileDescriptor_31aa11e9d7228300 = []byte{
	// 332 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *msgClient) IssueToken(ctx context.Context, in *MsgIssueToken, opts ...grpc.CallOption) (*MsgIssueTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/AutonomyNetwork.autonomychain.issuance.v1.Msg/IssueToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_IssueToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/AutonomyNetwork.autonomychain.issuance.v1.Msg/IssueToken",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "AutonomyNetwork.autonomychain.issuance.v1.Msg",
